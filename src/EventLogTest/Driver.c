...
#pragma alloc_text (PAGE, EventLogTestEvtDeviceAdd)
#pragma alloc_text (PAGE, EventLogTestEvtDriverContextCleanup)
#endif
...
--*/
{
    ...
    attributes.EvtCleanupCallback = EventLogTestEvtDriverContextCleanup;

    WDF_DRIVER_CONFIG_INIT(&config,
                           EventLogTestEvtDeviceAdd
                           );
...
--*/
{
    ...
    status = EventLogTestCreateDevice(DeviceInit);
...
VOID
EventLogTestEvtDriverContextCleanup(
